...
public class KerMLQualifiedEffectiveNameProvider extends DefaultDeclarativeQualifiedNameProvider {
	...
	protected Function<EObject, String> getResolver() {
		...
		return object -> {
			...
			if (unescapedName == null && object instanceof Element) {
				unescapedName = ((Element) object).effectiveName();
			}
